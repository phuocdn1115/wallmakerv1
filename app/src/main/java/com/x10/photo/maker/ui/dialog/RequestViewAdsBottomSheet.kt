...
import com.x10.photo.maker.databinding.LayoutRequestViewAdsBottomSheetBinding
...
@AndroidEntryPoint
class RequestViewAdsBottomSheet(private val onClickViewAds: () -> Unit, private val onDismiss: () -> Unit) :
    BaseDialog<LayoutRequestViewAdsBottomSheetBinding>() {
    @Inject
    lateinit var eventTrackingManager: EventTrackingManager

    override fun getLayoutResource(): Int {
        return R.layout.layout_request_view_ads_bottom_sheet
    }
