...
@AndroidEntryPoint
class FragmentProgressSavingVideo() : BaseDialog<LayoutFragmentProgressSavingVideoBinding>() {
    ...
    override fun setUp(view: View?) {
        viewModel.apply {
            myProgressing.observe(this@FragmentProgressSavingVideo){
            ...
            currentImageThumbSavingVideo.observe(this@FragmentProgressSavingVideo){
