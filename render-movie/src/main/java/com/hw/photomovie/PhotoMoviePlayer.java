...
public class PhotoMoviePlayer implements MovieTimer.MovieListener {
    ...
    private boolean isWindowMovie = false;
    ...
    public void setIsWindowMovie(PhotoMovieFactory.PhotoMovieType type){
        this.isWindowMovie = type == PhotoMovieFactory.PhotoMovieType.WINDOW;
    }
