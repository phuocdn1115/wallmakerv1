...
public class ScaleTransSegment extends AbsLayerSegment{
    ...
    private static final int SCALE_DURATION_SHORT = 3000;
    private static final int SCALE_DURATION_LONG = 4000;
    private static final int TRANS_DURATION_LONG = 1200;
    ...
    protected MovieLayer[] initLayers() {
        mScaleLayer = new ScaleTransLayer(1f, 1.2f);
